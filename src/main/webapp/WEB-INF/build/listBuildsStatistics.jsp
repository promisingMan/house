            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>楼盘统计 <small>Build Statistics</small></h2>
                            ...
                            <div class="x_title">
                                <button class="btn btn-round btn-primary" onclick="compare('month')">楼盘月度统计比较</button>
                                <button class="btn btn-round btn-success" onclick="compare('quarter')">楼盘季度统计比较</button>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                                ...
                                <table id="datatable-house" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="flat" name="option" value="${build.id}">
                                                </label>
                                            </div>
                                        </td>
                                        <td>${build.id}</td>
                                        ...
                                        <td>${build.phone}</td>
                                        <td>${build.num}</td>
                                        <td><a href="/build/monthStatistics?buildId=${build.id}" type="button" class="btn btn-round btn-primary">月度统计</a><a href="/build/quarterStatistics?buildId=${build.id}" type="button" class="btn btn-round btn-success">季度统计</a></td>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
...
<script>
    ...
    function compare(type) {
        ...
        if (params.length <= 1) {
            window.alert("请勾选表格多选框，最少2个，最多3个！");
            return false;
        }

        if (params.length > 3) {
            window.alert("对比数量不超过3");
            return false;
        }

        window.location.href = "${pageContext.request.contextPath}/build/compare?type=" + type + "&params=" + params;
    }
