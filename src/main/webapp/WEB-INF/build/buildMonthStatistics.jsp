  ...
  <body class="nav-md">
    ...
    <script>
      ...
      function init_echarts() {
        ...
        if ($('#sell').length) {
          var sellChart = echarts.init(document.getElementById('sell'), theme);

          // 装配数据
          var sellMonth = [];
          var totalSales = [];
          <c:forEach items="${sellMonth}" var="item">
          sellMonth.push("${item}" + "月");
          </c:forEach>
          <c:forEach items="${totalSales}" var="item">
        ...
        if ($('#lease').length) {
          var leaseChart = echarts.init(document.getElementById('lease'), theme);

          // 装配数据
          var leaseMonth = [];
          var totalLeases = [];
          <c:forEach items="${leaseMonth}" var="item">
          leaseMonth.push("${item}" + "月");
          </c:forEach>
          <c:forEach items="${totalLeases}" var="item">
          totalLeases.push("${item}");
          </c:forEach>
