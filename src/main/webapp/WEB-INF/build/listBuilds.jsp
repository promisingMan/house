                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-house" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>${build.phone}</td>
                                        <td>${build.num}</td>
                                        <c:if test="${sessionScope.user.roleid == 1}"><td><a href="/build/deleteBuild?buildId=${build.id}" type="button" class="btn btn-round btn-danger">删除</a><a href="/build/editBuild?buildId=${build.id}" type="button" class="btn btn-round btn-primary">修改</a></td></c:if>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
