                                ...
                                <ul class="nav child_menu" style="display: block;">
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <c:forEach items="${permission.value}" var="fun">
                                            <c:choose>
                                                <c:when test="${fun.permissionname == '查看出租'}">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>修改出租 <small>Modify Lease</small></h2>
                            ...
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/lease/saveLease">
                                    <input type="hidden" name="type" value="edit"/>
                                    <input type="hidden" name="id" value="${lease.id}">
                                    <input type="hidden" id="buildname" name="buildname" value="${lease.buildname}">
                                    <input type="hidden" id="customername" name="customername" value="${lease.customername}">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="buildid" name="buildid" class="select2_single form-control" tabindex="-1">
                                                ...
                                                <c:forEach items="${builds}" var="build">
                                                    <c:choose>
                                                        <c:when test="${lease.buildid == build.id}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="location" value="${lease.location}" id="location" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="price">租金(元/月) <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="price" value="${lease.price}" id="price" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select id="customerid" name="customerid" class="select2_single form-control" tabindex="-1">
                                                ...
                                                <c:forEach items="${customers}" var="customer">
                                                    <c:choose>
                                                        <c:when test="${lease.customerid == customer.id}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="phone" value="${lease.phone}" id="phone" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="status">状态 <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="status" value="${lease.status}" id="status" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leasetype">出租方式 <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="leasetype" value="${lease.leasetype}" id="leasetype" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="payment">支付方式 <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="payment" value="${lease.payment}" id="payment" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="datetimepicker">出租日期 <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="datetimepicker" value="<fmt:formatDate value="${lease.date}" pattern="yyyy-MM-dd HH:mm:ss"/>" name="date" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
