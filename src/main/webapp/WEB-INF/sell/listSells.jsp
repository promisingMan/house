                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-house" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>${sell.status}</td>
                                        <td>${sell.selltype}</td>
                                        <td><fmt:formatDate value="${sell.date}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                        <c:if test="${sessionScope.user.roleid == 1}"><td><a href="/sell/deleteSell?sellId=${sell.id}" type="button" class="btn btn-round btn-danger">删除</a><a href="/sell/editSell?sellId=${sell.id}" type="button" class="btn btn-round btn-primary">修改</a></td></c:if>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
