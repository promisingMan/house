            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>客户列表 <small>Customers</small></h2>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-house" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${sessionScope.user.roleid == 1}"><td><a href="/customer/delCustomer?customerId=${customer.id}" type="button" class="btn btn-round btn-danger">删除</a><a href="/customer/editCustomer?customerId=${customer.id}" type="button" class="btn btn-round btn-primary">修改</a></td></c:if>
                                    </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
