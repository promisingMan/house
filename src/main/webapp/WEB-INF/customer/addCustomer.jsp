                                ...
                                <ul class="nav child_menu" style="display: block;">
                                    ...
                                    <ul class="nav child_menu">
                                        ...
                                        <c:forEach items="${permission.value}" var="fun">
                                            <c:choose>
                                                <c:when test="${fun.permissionname == '添加客户'}">
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>添加客户 <small>Add Customer</small></h2>
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/customer/saveCustomer">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="customername" id="customername" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div id="gender" class="btn-group" data-toggle="buttons">
                                                <label id="male" class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                                                    <input type="radio" name="sex" value="1" checked="checked"> &nbsp; 男 &nbsp;
                                                </label>
                                                <label id="female" class="btn btn-default" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
