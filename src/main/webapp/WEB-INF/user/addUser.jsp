                        ...
                        <ul class="nav side-menu">
                            <c:forEach items="${permissions}" var="permission">
                                <li>
                                    <a>
                                        <c:choose>
                                            <c:when test="${permission.key.id == 1}">
                                                <i class="fa fa-user"></i>
                                            </c:when>
                                            <c:when test="${permission.key.id == 2}">
                                                <i class="fa fa-users"></i>
                                            </c:when>
                                            <c:when test="${permission.key.id == 3}">
                                                <i class="fa fa-building"></i>
                                            </c:when>
                                            <c:when test="${permission.key.id == 4}">
                                                <i class="fa fa-building-o"></i>
                                            </c:when>
                                            <c:when test="${permission.key.id == 5}">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="/user/addUser">
